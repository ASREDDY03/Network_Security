...
class DataIngestion:
    def __init__(self,data_ingestion_config:DatatIngestionConfig):
        try:
    ...
    def export_collection_as_dataframe(self):
        try:
            ...
            df.replace({"na":np.nan},inlace=True)
            return df
    ...
    def initiate_data_ingesion(self):
        try:
            ...
            DatatIngestionArtifact(trained_file_path=self.data_ingestion_config.training_file_path,
            test_file_path=self.data_ingestion_config.testing_file_path)
            return DatatIngestionArtifact
